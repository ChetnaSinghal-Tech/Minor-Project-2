document.addEventListener('DOMContentLoaded', () => {
    ...
    if(profileForm) {
        profileForm.addEventListener('submit', (e) => {
            ...
            const newBlood = document.getElementById('editBlood').value;
            ...
            setTimeout(() => {
                ...
                const profileTitle = document.querySelector('.hero-content h1 span');
                const bloodStat = document.querySelector('.stat-card.red .status-ok');
                
                if(profileTitle) profileTitle.innerText = newName;
                if(bloodStat) bloodStat.innerText = `${newBlood} Blood Type`;
